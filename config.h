...
static char *fonts[]          = {
	...
	"Source Han Sans JP:antialias=true:autohint=true:size=12",
	"Noto Sans:antialias=true:autohint=true:size=12",
};
...
static char titlefgcolor[]          = "#00ffff";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_d,      sendcmd,        {0} },
